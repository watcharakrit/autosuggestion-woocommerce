...
!function (n, r) {
  ...
  var h = function () {
    ...
    return n.prototype.update = function (n) {
      var r, t = 0, e = this.S >>> 5, i = this.m(n, this.u, this.s), o = i.binLen, u = i.value, f = o >>> 5;
      for (r = 0; r < f; r += e)
        t + this.S <= o && (this.p = this.R(u.slice(r, r + e), this.p),
          t += this.S);
      this.v += t,
        this.u = u.slice(t >>> 5),
        this.s = o % this.S,
      ...
      n.prototype.getHash = function (n, r) {
        ...
        if (!0 === this.A && this.F)
          return f(this.F(u));
        for (i = this.K(this.u.slice(), this.s, this.v, this.B(this.p), o),
          t = 1; t < this.numRounds; t += 1)
          !0 === this.C && o % 32 != 0 && (i[i.length - 1] &= 16777215 >>> 24 - o % 32),
      ...
      n.prototype.k = function (n) {
        ...
        for (t < n.binLen / 8 && (n.value = this.K(n.value, n.binLen, 0, this.L(this.o), this.U)); n.value.length <= e;)
          n.value.push(0);
        for (r = 0; r <= e; r += 1)
          this.l[r] = 909522486 ^ n.value[r],
            this.H[r] = 1549556828 ^ n.value[r];
        this.p = this.R(this.l, this.p),
          this.v = this.S,
          this.A = !0
      }
      ,
      ...
      n.prototype.Y = function () {
        ...
        return n = this.R(this.H, this.L(this.o)),
  ...
  function T(n, r) {
    ...
    for (t = r[0],
      ...
      u = r[4],
      w = 0; w < 80; w += 1)
      s[w] = w < 16 ? n[w] : A(s[w - 3] ^ s[w - 8] ^ s[w - 14] ^ s[w - 16], 1),
        f = w < 20 ? y(A(t, 5), H(e, i, o), u, 1518500249, s[w]) : w < 40 ? y(A(t, 5), b(e, i, o), u, 1859775393, s[w]) : w < 60 ? y(A(t, 5), S(e, i, o), u, 2400959708, s[w]) : y(A(t, 5), b(e, i, o), u, 3395469782, s[w]),
        u = o,
        o = i,
        i = A(e, 30),
        e = t,
  ...
  var K = function (n) {
    function r(r, e, i) {
      ...
      if ("SHA-1" !== r)
        throw new Error(f);
      var u = i || {};
      return (o = n.call(this, r, e, i) || this).g = !0,
        o.F = o.Y,
        o.T = -1,
        o.m = t(o.t, o.i, o.T),
        o.R = T,
  ...
  function L(n, r) {
    ...
    for (t = r[0],
      ...
      a = r[7],
      v = 0; v < 64; v += 1)
      b[v] = v < 16 ? n[v] : p(E(A = b[v - 2], 17) ^ E(A, 19) ^ l(A, 10), b[v - 7], R(b[v - 15]), b[v - 16]),
  ...
  var g = function (n) {
    function r(r, e, i) {
      var o = this;
      if (!1 == ("SHA-224" === r || "SHA-256" === r))
        throw new Error(f);
      var u = i || {};
      return (o = n.call(this, r, e, i) || this).F = o.Y,
        o.g = !0,
        o.T = -1,
        o.m = t(o.t, o.i, o.T),
        o.R = L,
        ...
        o.K = function (n, t, e, i) {
          return function (n, r, t, e, i) {
            for (var o, u = 15 + (r + 65 >>> 9 << 4), f = r + t; n.length <= u;)
              n.push(0);
            for (n[r >>> 5] |= 128 << 24 - r % 32,
              n[u] = 4294967295 & f,
  ...
  function Y(n, r) {
    var t;
    return r > 32 ? (t = 64 - r,
      new k(n.I << r | n.N >>> t, n.N << r | n.I >>> t)) : 0 !== r ? (t = 32 - r,
        new k(n.N << r | n.I >>> t, n.I << r | n.N >>> t)) : n
  }
  function N(n, r) {
    var t;
    return r < 32 ? (t = 32 - r,
      new k(n.N >>> r | n.I << t, n.I >>> r | n.N << t)) : (t = 64 - r,
  ...
  function O(n, r) {
    ...
    return t = (65535 & n.N) + (65535 & r.N) + (e >>> 16),
  ...
  function j(n, r, t, e) {
    ...
    return i = (65535 & n.N) + (65535 & r.N) + (65535 & t.N) + (65535 & e.N) + (o >>> 16),
      o = (n.N >>> 16) + (r.N >>> 16) + (t.N >>> 16) + (e.N >>> 16) + (i >>> 16),
  ...
  function _(n, r, t, e, i) {
    ...
    return o = (65535 & n.N) + (65535 & r.N) + (65535 & t.N) + (65535 & e.N) + (65535 & i.N) + (u >>> 16),
      u = (n.N >>> 16) + (r.N >>> 16) + (t.N >>> 16) + (e.N >>> 16) + (i.N >>> 16) + (o >>> 16),
  ...
  function D(n, r) {
    ...
    for (t = r[0],
      ...
      c = 0; c < 80; c += 1)
      c < 16 ? (v = 2 * c,
        H[c] = new k(n[v], n[v + 1])) : H[c] = j((A = H[c - 2],
          E = void 0,
          l = void 0,
          b = void 0,
          E = N(A, 19),
          l = N(A, 61),
          b = I(A, 6),
          new k(E.N ^ l.N ^ b.N, E.I ^ l.I ^ b.I)), H[c - 7], x(H[c - 15]), H[c - 16]),
  ...
  var G = function (n) {
    function r(r, e, i) {
      ...
      return (o = n.call(this, r, e, i) || this).F = o.Y,
        ...
        o.K = function (n, t, e, i) {
          return function (n, r, t, e, i) {
            for (var o, u = 31 + (r + 129 >>> 10 << 5), f = r + t; n.length <= u;)
              n.push(0);
            for (n[r >>> 5] |= 128 << 24 - r % 32,
              n[u] = 4294967295 & f,
              n[u - 1] = f / 4294967296 | 0,
  ...
  function nn(n, r) {
    ...
    if (null !== n)
      for (e = 0; e < n.length; e += 2)
        r[(e >>> 1) % 5][(e >>> 1) / 5 | 0] = P(r[(e >>> 1) % 5][(e >>> 1) / 5 | 0], new k(n[e + 1], n[e]));
    for (t = 0; t < 24; t += 1) {
      for (o = W(),
        e = 0; e < 5; e += 1)
        h[e] = (u = r[e][0],
      ...
      for (e = 0; e < 5; e += 1)
        for (i = 0; i < 5; i += 1)
          r[e][i] = P(o[e][i], new k(~o[(e + 1) % 5][i].N & o[(e + 2) % 5][i].N, ~o[(e + 1) % 5][i].I & o[(e + 2) % 5][i].I));
      r[0][0] = P(r[0][0], J[t])
    }
    return r
  }
      ...
      return o.K = function (n, r, t, e, i) {
        return function (n, r, t, e, i, o, u) {
          ...
          for (n[(f = r >>> 3) >> 2] ^= o << f % 4 * 8,
            n[h - 1] ^= 2147483648,
            e = nn(n, e); 32 * a.length < u && (w = e[s % 5][s / 5 | 0],
              a.push(w.I),
              !(32 * a.length >= u));)
            a.push(w.N),
              0 == 64 * (s += 1) % i && (nn(null, e),
                s = 0);
          return a
        }(n, r, 0, e, w, u, i)
      }
    ...
    return v(r, n),
      r.prototype.O = function (n, r) {
        ...
        if (0 !== t.customization.binLen || 0 !== t.funcName.binLen) {
          for (var i = en(e, this.S >>> 3), o = 0; o < i.length; o += this.S >>> 5)
      ...
      r.prototype.M = function (n) {
        ...
        this.O(n, r.funcName);
        for (var t = en(tn(r.kmacKey), this.S >>> 3), e = 0; e < t.length; e += this.S >>> 5)
